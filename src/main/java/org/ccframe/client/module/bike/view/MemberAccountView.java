...
@Singleton
public class MemberAccountView extends BasePagingListView<MemberAccountRowDto> {

	interface MemberAccountUiBinder extends UiBinder<Component, MemberAccountView> {}
