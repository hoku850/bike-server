...
public interface CyclingOrderClient extends RestService{
	...
	void getCyclingOrderDtoById(@PathParam(Global.ID_BINDER_ID) Integer cyclingOrderId, RestCallback<CyclingOrderRowDto> callback);
	...
	void findList(CyclingOrderListReq cyclingOrderListReq, @QueryParam("offset") int offset, @QueryParam("limit") int limit, RestCallback<CyclingOrderClientPage<CyclingOrderRowDto>> callback);
