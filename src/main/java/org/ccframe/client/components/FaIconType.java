...
public enum FaIconType {
    ...
    private FaIconType(String code){
    	this.code = code;
    }
    ...
    public static FaIconType fromCode(String code){
		for(FaIconType faIconType: values()){
			if(faIconType.code.equals(code)){
				return faIconType;
			}
		}
		return null;
