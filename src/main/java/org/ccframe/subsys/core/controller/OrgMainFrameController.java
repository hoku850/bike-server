...
import org.ccframe.subsys.core.service.OrgUserRelSearchService;
...
@RestController
@RequestMapping(ControllerMapping.MAIN_FRAME_ORG_BASE)
public class OrgMainFrameController{
	...
	public BoolCodeEnum doLogin(String loginId, String userPsw, String validateCode) {
		//检验验证码
        ...
        User user = SpringContextHelper.getBean(UserService.class).getByMultiLoginIdUserPswOrgId(loginId, userPsw, null);
		...
		AdminUser adminUser = AdminUser.create(user, orgUserRelList.get(0).getOrgId()); 
