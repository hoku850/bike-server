...
public class ToolbarLine {
	 ...
	 * add by Jim 140511
	 */
	public ToolbarLine(CKConfig.TOOLBAR_OPTIONS[] configOptions){
		blocks = new ArrayList<TOOLBAR_OPTIONS>();
		for(TOOLBAR_OPTIONS optios: configOptions){
			blocks.add(optios);
		}
	}
	...
	public void addBlockSeparator(){
		blocks.add(TOOLBAR_OPTIONS._DASH);
	}
