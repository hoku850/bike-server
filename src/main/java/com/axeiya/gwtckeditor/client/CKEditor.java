...
public class CKEditor extends Composite implements HasSaveHandlers<CKEditor>, HasValueChangeHandlers<String>, ClickHandler, HasAlignment, HasHTML,
	...
	private native void replaceTextArea(Object o, JavaScriptObject config) /*-{
		my = $wnd.CKEDITOR
				.replace(o, config);
		this.@com.axeiya.gwtckeditor.client.CKEditor::editor = my;
	...
	public native void insertHTML(String html)/*-{
		var e = this.@com.axeiya.gwtckeditor.client.CKEditor::editor;
		e.insertHtml(html);
		//move cursor to append next
		var ranges = e.getSelection().getRanges();
		ranges[0].collapse(false);
		e.getSelection().selectRanges( ranges );
	}-*/;
	...
	public native void destory() /*-{
		$wnd.CKEDITOR.remove(this.@com.axeiya.gwtckeditor.client.CKEditor::editor);
	}-*/;

	public native boolean isReady() /*-{
		return this.@com.axeiya.gwtckeditor.client.CKEditor::editor.status == 'ready';
	}-*/;
